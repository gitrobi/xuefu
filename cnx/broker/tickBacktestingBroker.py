# PyAlgoTrade
##author xuefu $date
#reload the function broker.createMarketOrder()
...
class MarketOrder(broker.MarketOrder, BacktestingOrder):
    def __init__(self, action, instrument, quantity, onOpposite, instrumentTraits):
        super(MarketOrder, self).__init__(action, instrument, quantity, onOpposite, instrumentTraits)
...
class Broker(broker.Broker):
    ...
    def __init__(self, cash, barFeed, commission=None):
        ...
        self.__fillStrategy = tickFillStrategy.DefaultStrategy()
    ...
    def createMarketOrder(self, action, instrument, quantity, onOpposite=False):
        ...
        return MarketOrder(action, instrument, quantity, onOpposite, self.getInstrumentTraits(instrument))
